...
const WhyChooseSection = () => {
    const data = [
        {
            label: "Wide range of brands",
            desc: "We can help with your financing plan, we can offer some tips and tricks. Drive off with this dream car of yours regardless of your credit history.",
            color: "icon-orange",
            icon: (
                    ...
                    <g id="money2" transform="translate(-91.358)">
                        <g id="Group_568" data-name="Group 568" transform="translate(91.358)">
                            ...
                            <g id="Group_565" data-name="Group 565" transform="translate(8.504 5.642)">
                                <circle id="Ellipse_125" data-name="Ellipse 125" cx="1.677" cy="1.677" r="1.677" fill="#0575ff"></circle>
                            </g>
                            <path
                                id="Union_22"
                                data-name="Union 22"
    ...
    return (
        <Box className="container section" id="services">
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: {xs: "1fr", md: "1fr 1fr", lg: "1fr 1fr 1fr"}, mt: 7, gap: 5 }}>
                {data.map((item) => (
                    <Box sx={{ margin: "auto" }}>
                        <Box
                            sx={{
                        ...
                        <Typography component="h1" textAlign="center" mt={4} fontSize={20} lineHeight={0.9} color="dark.400">
                            {item.label}
                        </Typography>
                        <Typography component="p" textAlign="center" mt={3} color="dark.100">
                            {item.desc}
                        </Typography>
                    </Box>
                ))}
